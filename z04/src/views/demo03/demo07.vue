    ...
    <!--<el-timeline>-->
      ...
      <!--&gt;-->
        ...
        <!--&gt;-->
          ...
          <!--&lt;!&ndash;<span>Hi there! {{index}}</span>&ndash;&gt;-->
                ...
                <!--<el-container>-->
                  <!--<el-header>-->
                    <!--<el-row>-->
                      ...
                      <!--<el-col :span="18"> <h3> {{dateThing[index].text}}</h3>-->
                      <!--</el-col>-->
                      <!--<el-col :span="4">-->
                      <!--</el-col>-->
                    <!--</el-row>-->
              ...
              <!--<el-card shadow="hover"   >-->
                ...
                <!--<el-container>-->
                  ...
                  <!--<el-main >-->
                    ...
                    <!--<p> 开始时间: {{this.$dayjs(activity.start).format('YYYY-MM-DD HH:mm:ss')}}</p>-->

                    <!--<p>    结束时间: {{this.$dayjs(activity.end).format('YYYY-MM-DD HH:mm:ss')}}</p>-->
                    <!--<el-divider></el-divider>-->
...
<!--&lt;!&ndash;增加，判断时间，最终  还是决定 在edit 时up 到数据库&ndash;&gt;-->
...
<!--<template>-->
  ...
  <!--&lt;!&ndash;{{this.$dayjs(choiceDate).format("YYYY-MM-DD HH:mm:ss")}}&ndash;&gt;-->
  <!--<div class="block" >-->
    <!--<el-timeline>-->
  ...
  <!--<div class="block">-->
    <!--<el-timeline>-->
      ...
      <!--&gt;-->
        ...
        <!--<el-card id="card" shadow="hover"  @mouseover="itemMouseover"-->
      ...
      <!--return{-->
        ...
        <!--activities: [-->
          ...
          <!--{-->
            ...
            <!--timestamp: '2018-04-03 20:43',-->
            <!--color: '#0bbd87',-->
          <!--},-->
          <!--{-->
            <!--content: 'Custom size',-->
            <!--timestamp: '2018-04-03 20:41',-->
            <!--size: 'large',-->
            <!--color: '#8c70bd',-->
            <!--icon: MagicStick-->
          <!--},-->
